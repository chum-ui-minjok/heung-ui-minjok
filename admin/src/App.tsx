  ...
  return (
    <BrowserRouter basename="/admin">
      <Routes>
        ...
        <Route path="/dashboard/developer/song-upload" element={<SimpleSongUploadPage />} />
        <Route path="/dashboard/developer/visualization" element={<SongVisualizationPage />} />
        <Route path="/dashboard/developer/admin-management" element={<AdminManagementPage />} />
